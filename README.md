...
3. If needed, update the 7-Zip path in the script to match your installation
...
4. Follow the interactive prompts for each game
5. Compressed games will be saved to the destination directory
